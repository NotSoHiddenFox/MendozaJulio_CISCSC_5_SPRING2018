 ...
 *      Add a value to the cards: IN PROGRESS
 ...
 * Current Challenge:
 *                  The value and isDupe functions are not working together 
 *                  properly, bugfix is needed.
 */
...
int main(int argc, char** argv) {
    ...
    if (isDupe(playOne, 5, playOne[p1Round], p1Round) == true) {
        ...
        do {
            ...
            if (isDupe(playOne, 5, playOne[p1Round], p1Round) == false) p1ReDraw = false;
    ...
    cout << "You have drawn a " << playOne[0] << " and "
            << playOne[1] << "." << endl;
    ...
    //state the current cards held
    cout << "You drew a " << playOne[2] << " and placed it next to your " << endl;
    cout << playOne[0] << ", ";
    cout << playOne[1] << ".\n";
    ...
    //state the current cards held.
    cout << "You drew a " << playOne[3] << " and placed it next to your " << endl;
    cout << playOne[0] << ", ";
    cout << playOne[1] << ", ";
    cout << playOne[2] << ".\n";
